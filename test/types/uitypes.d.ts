declare namespace uit {
  ...
  namespace Bag {
    type BagRoleWindow = __UIComponent<
      ...
      string
    >;
    type BagWindow = __UIComponent<fairygui.GComponent, { loaderTitle: fairygui.GLoader }, string, string>;
  ...
  namespace MainUI {
    type MainUIView = __UIComponent<
      fairygui.GComponent,
      {
        ...
        MainUITopMiddleView: fairygui.GComponent;
    ...
    namespace Views {
      ...
      type BottomMiddle = __UIComponent<
        fairygui.GComponent,
        {
          ...
          btnOpenChat: MainUI.Components.TopMiddle.BtnEmpty;
      ...
      type TopRight = __UIComponent<
        fairygui.GComponent,
        {
          ...
          btnSmallMap: MainUI.Components.emptyBtn;
      ...
      type TopLeft = __UIComponent<
        fairygui.GComponent,
        {
          ...
          btnFight: MainUI.Components.emptyBtn;
    ...
    namespace Components.BottomMiddle {
      ...
      type ProgressHp = __UIComponent<fairygui.GProgressBar, { bar_v: fairygui.GComponent }, string, string>;
      type ProgressMp = __UIComponent<fairygui.GProgressBar, { bar_v: fairygui.GComponent }, string, string>;
    ...
    namespace Components.TopLeft {
      ...
      type BtnPreview = __UIComponent<
        ...
        string
      >;
      type progressBar_hp = __UIComponent<fairygui.GProgressBar, { bar: fairygui.GComponent }, string, string>;
      type progressBar_mp = __UIComponent<fairygui.GProgressBar, { bar: fairygui.GComponent }, string, string>;
      type progressBar_xp = __UIComponent<fairygui.GProgressBar, { bar: fairygui.GComponent }, string, string>;
    ...
    namespace Components.TopMiddle {
      type RoleHeadInfo = __UIComponent<
        fairygui.GComponent,
        {
          ...
          btnRole: MainUI.Components.TopMiddle.BtnEmpty;
    ...
    namespace Components.Pop {
      type PopBottomMiddle = __UIComponent<
        fairygui.GComponent,
        { btnClose: fairygui.GButton; tip: fairygui.GRichTextField; btnCon: MainUI.Components.emptyBtn },
        string,
        string
      >;
      type PopMiddleRight = __UIComponent<
        fairygui.GComponent,
        { btnClose: fairygui.GButton; tip: fairygui.GTextField; btnCon: MainUI.Components.emptyBtn },
        'button',
        string
      >;
    ...
    namespace Components.TopLeft.vip {
      type VipView = __UIComponent<
        fairygui.GComponent,
        {
          ...
          btnVip: MainUI.Components.emptyBtn;
  ...
  namespace UILib {
    ...
    namespace Components.progressBar {
      ...
      type progressBar_green = __UIComponent<
        ...
        string
      >;
      type progressBar_white = __UIComponent<fairygui.GProgressBar, { bar: fairygui.GComponent }, string, string>;
